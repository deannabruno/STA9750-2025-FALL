...
download_council_district_boundaries <- function() {
  ...
  shp_file <- list.files(upz_dir, pattern = "\\.shp$", full.names = TRUE)
...
![Fall scenery includes the Belvedere Castle and Turtle Pond. Scott Dunn/National Geographic.](docs/CPNYC.png)
...
To simplify the proposal, here are the key components:
-  **Replace dead trees**
- **New plantings:** 800 native species trees  
